...
<template>
  <form @submit.prevent="onSubmit" style="max-width: 500px; margin: 0 auto;">
    ...
    <input type="text" id="name" v-model="name" style="width: 100%; padding: 8px; margin-bottom: 16px;"/>
    <span v-if="errors.name" style="color: red">{{ errors.name }}</span>

    <label for="price" style="display: block; margin-bottom: 8px;">Price:</label>
    <input type="number" id="price" v-model="price" style="width: 100%; padding: 8px; margin-bottom: 16px;"/>
    ...
    <textarea id="description" v-model="description" style="width: 100%; padding: 8px; margin-bottom: 16px;"></textarea>
